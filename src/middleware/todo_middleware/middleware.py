...
from src.middleware.todo_middleware.state import PlanningState
from src.middleware.todo_middleware.write_todo_tool import write_todos
from src.middleware.todo_middleware.prompt import WRITE_TODOS_SYSTEM_PROMPT
...
class TodoListMiddleware(
    ...
    def _check_for_parallel_tool_calls(self, state: PlanningState) -> dict | None:
    ...
    async def aafter_model(self, state, runtime):
        return self._check_for_parallel_tool_calls(state)
