...
def format_skills_for_prompt() -> str:
    ...
    return (
        ...
        "**How to Use Skills:**\n"
        "\n"
        "Skills provide specialized workflows for common tasks. "
        "When a user's request matches a skill's domain:\n"
        "\n"
        "1. **Recognize when a skill applies**: Check if the user's task matches a skill's description\n"
        "2. **Read the skill**: Use `read_file` on the skill's SKILL.md path to get the full workflow instructions\n"
